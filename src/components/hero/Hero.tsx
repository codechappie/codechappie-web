...
const Hero = () => {
  return (
    <HeroStyled>
      <HeroContainer>
        <MainText>
          <h1>Explora el mundo del desarrollo</h1>
          <p>
            Pasa un buen rato, conoce nuevos temas, adquiere nuevas habilidades, cambia tu mundo.
          </p>
